...
# MODEL_PATH=${MODEL_PATH:-"/home/bingxing2/home/scx7euw/.cache/modelscope/hub/models/Qwen/"}
...
# MODEL=${MODEL_NAME:-"Baichuan2-13B-Chat"}
# MODEL=${MODEL_NAME:-"Qwen1.5-MoE-A2.7B-Chat"}
BATCH_SIZE_OPTS=(2)
SEQ_LENGTH_OPTS=(512)
